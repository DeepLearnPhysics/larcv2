#ifndef __MaskCluster3D_CXX__
#define __MaskCluster3D_CXX__

#include "MaskCluster3D.h"
#include "larcv/core/DataFormat/EventVoxel3D.h"
namespace larcv {

  static MaskCluster3DProcessFactory __global_MaskCluster3DProcessFactory__;

  MaskCluster3D::MaskCluster3D(const std::string name)
    : ProcessBase(name)
  {}

  void MaskCluster3D::configure_labels(const PSet& cfg)
  {
    ...
    if (_target_producer_v.empty()) {
      auto target_producer    = cfg.get<std::string>("Cluster3DProducer",  "");
  ...
  void MaskCluster3D::configure(const PSet& cfg)
  {
  ...
  void MaskCluster3D::initialize()
  {}

  bool MaskCluster3D::process(IOManager& mgr)
  {
